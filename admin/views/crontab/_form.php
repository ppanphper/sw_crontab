    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="box box-info table-responsive">
                ...
                <div class="box-body">
                    <?= $form->field($model, 'cid')->widget(SelectizeDropDownList::className(), [
                    ...
                    <?= $form->field($model, 'command')->textarea(['rows' => '6', 'maxlength' => true, 'placeholder' => Yii::t('app', 'Please enter the command to execute, must use absolute path.')])->hint('eg: /usr/bin/php /data/path/cli.php crontab test "params"') ?>
                    ...
                    <?= $form->field($model, 'owner')->widget(SelectizeDropDownList::className(), [
                    ...
                    <?= $form->field($model, 'agents')->widget(SelectizeDropDownList::className(), [
                    ...
                    <?= $form->field($model, 'notice_way')->widget(SelectizeDropDownList::className(), [
                        'items'   => $noticeWayMaps,
                        'options' => [
