...
CREATE TABLE `agents` (
  ...
  `last_report_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '最近上报时间',
  `agent_status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '节点状态 0=离线 1=正常 2=在线, 但Redis没有上报',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='存放授权条目';
...
# Dump of table via_table
# ------------------------------------------------------------

DROP TABLE IF EXISTS `via_table`;

CREATE TABLE `via_table` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='中间表';
